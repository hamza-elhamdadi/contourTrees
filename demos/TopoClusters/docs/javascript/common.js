...
function insert_navbar( curpage ){
    html = `<nav class="navbar navbar-expand-lg navbar-light bg-light">
              <a class="navbar-brand" href="index.html">TopoCluster</a>
...
function add_scales( chart_name, xExt, yExt, lc_margin = {left: 30, right: 5, top: 5, bottom: 20} ){
...
function init_linechart( chart_name, xExt, yExt, lc_margin = {left: 30, right: 5, top: 5, bottom: 20} ){
...
function insert_linechart( chart, data, class_name, click_func = null ){
...
function add_linechart( chart_name, data, xExt, yExt, class_name, lc_margin = {left: 30, right: 5, top: 5, bottom: 20}, stroke_size = 3 ){
